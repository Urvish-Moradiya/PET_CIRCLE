...
const LoginModal = () => {
  ...
  const submitHandler = async (data) => {
    setLoading(true);
    try {
      console.log("LoginModal - Submitting:", { email: data.email });
      const response = await axios.post("http://localhost:5000/api/login", {
        email: data.email,
        password: data.password,
      });
      console.log("LoginModal - Raw response:", response);
      console.log("LoginModal - Response data:", response.data);
      ...
      console.log("LoginModal - Stored token:", localStorage.getItem("authToken"));
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-500 bg-gray-50 transition-all duration-300"
                    placeholder="••••••••"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-fuchsia-600 focus:outline-none"
                    disabled={loading}
                  >
